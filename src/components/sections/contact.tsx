...
export function Contact() {
  ...
  return (
    <Section id="contact" rail="07 — Contact">
      <Reveal>
        <h2 className="max-w-2xl font-display text-3xl leading-tight tracking-tight text-ink md:text-5xl">
      ...
      <Reveal delay={0.1}>
        <div className="mt-10 flex flex-col items-start gap-3 sm:flex-row sm:items-center">
          <Link
            ...
            className="group inline-flex items-center gap-2 rounded-full bg-ink px-5 py-3 font-sans text-sm text-paper transition-colors hover:bg-accent-ink"
          >
